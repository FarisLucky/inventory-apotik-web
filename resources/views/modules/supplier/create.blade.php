                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h2 class="panel-title">Create Supplier</h2>
                        ...
                        <div class="panel-body">
                            <form action="{{ route('supplier.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_pbf" id="no_pbf" class="form-control" placeholder="No PBF" value="{{ old('no_pbf') }}">
                                    @error('no_pbf')
                                    <p class="text-danger">
                                        {{ $message }}
                                    </p>
                                ...
                                <div class="form-group">
                                    <label for="nama_supplier">No PBF</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telp" id="telp" class="form-control" placeholder="Telepon" value="{{ old('telp') }}">
                                    @error('telp')
                                    <p class="text-danger">
                                        {{ $message }}
                                    </p>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fax" id="fax" class="form-control" placeholder="Fax" value="{{ old('fax') }}">
                                    @error('fax')
                                    <p class="text-danger">
                                        {{ $message }}
                                    </p>
