                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">List Satuan</h3>
                            <div class="right">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route("satuan.edit",['id_satuan'=>$s->id_satuan]) }}" class="btn btn-warning mb-2">
                                                Edit
                                            </a>
                                            <form class="destroy" action="{{ route('satuan.destroy',['id_satuan'=>$s->id_satuan]) }}" method="post">
                                                @csrf
